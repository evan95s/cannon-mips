...
func (s *StateDB) deleteStateObject(addr common.Address) {
	...
	// oracle.PrefetchAccount(big.NewInt(oracle.GetBlockNumber().Int64()+1), addr, nil)
...
func (s *StateDB) getDeletedStateObject(addr common.Address) *stateObject {
	...
	if data == nil {
		...
		var err error
		// fmt.Printf("%x\n", addr.Bytes())
		// panic(oracle.GetBlockNumber().Uint64())
		// fmt.Println("get account:", addr)
		// oracle.PrefetchAccount(oracle.GetBlockNumber(), addr, nil)
...
func (s *StateDB) Finalise(deleteEmptyObjects bool) {
	// fmt.Println("Finalise with ", deleteEmptyObjects)
